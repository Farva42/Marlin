...
#define LCD_SERIAL_PORT 3              // Added by config.ini 2024-10-11 10:34:07
#define NO_CREALITY_422_DRIVER_WARNING // Added by config.ini 2024-10-11 10:34:07
...
#define CUSTOM_MACHINE_NAME "Beltz"
 ...
 */
  ...
  #define MPC_SENSOR_RESPONSIVENESS { 0.2513f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1346f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1486f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define MPC_TUNING_POS { X_CENTER, Y_CENTER, .1f } // (mm) M306 Autotuning position, ideally bed center at first layer height.
...
#define MAG_MOUNTED_PROBE
  ...
  #define MAG_MOUNTED_DEPLOY_2 { PROBE_DEPLOY_FEEDRATE, { 210, 114, 20 } }  // Move probe off dock
  //#define MAG_MOUNTED_DEPLOY_3 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  //#define MAG_MOUNTED_DEPLOY_4 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  //#define MAG_MOUNTED_DEPLOY_5 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  #define MAG_MOUNTED_STOW_1 { PROBE_STOW_FEEDRATE, { 245, 114, 20 } }    // Move to dock
  #define MAG_MOUNTED_STOW_2 { PROBE_STOW_FEEDRATE, { 245, 114, 0 } }    // Place probe beside remover
  #define MAG_MOUNTED_STOW_3 { PROBE_STOW_FEEDRATE, { 233, 114, 0 } }    // Side move to remove probe
  #define MAG_MOUNTED_STOW_4 { PROBE_STOW_FEEDRATE, { 230, 114, 20 } }    // Side move to remove probe
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 1, 28, -8.69 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 35, 30, 30, 30 } // (mm) Left, Front, Right, Back insets
