...
#define CUSTOM_MACHINE_NAME "SKR2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 141.94 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 100, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -9, -1.82 }
...
#define HOMING_FEEDRATE_MM_M { (70*60), (70*60), (30*60) }
