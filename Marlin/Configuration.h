...
#define DIAG_JUMPERS_REMOVED           // Added by config.ini 2024-10-11 08:37:00
...
#define STRING_CONFIG_H_AUTHOR "Farva" // Who made the changes.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.13f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1718f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0900f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1164f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 102.01
  #define DEFAULT_bedKi 18.75
  #define DEFAULT_bedKd 369.97
...
#define MAG_MOUNTED_PROBE
  ...
  #define PROBE_DEPLOY_FEEDRATE (170*60)  // (mm/min) Probe deploy speed
  #define PROBE_STOW_FEEDRATE (150*60)    // (mm/min) Probe stow speed

  #define MAG_MOUNTED_DEPLOY_1 { PROBE_DEPLOY_FEEDRATE, { 286, 125, 30 } }  // Move to side Dock & Attach probe
  #define MAG_MOUNTED_DEPLOY_2 { PROBE_DEPLOY_FEEDRATE, { 270, 125, 30 } }  // Move probe off dock
  #define MAG_MOUNTED_DEPLOY_3 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  #define MAG_MOUNTED_DEPLOY_4 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  #define MAG_MOUNTED_DEPLOY_5 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  #define MAG_MOUNTED_STOW_1 { PROBE_STOW_FEEDRATE, { 286, 125, 20 } }    // Move to dock
  #define MAG_MOUNTED_STOW_2 { PROBE_STOW_FEEDRATE, { 286, 125, 0 } }    // Place probe beside remover
  #define MAG_MOUNTED_STOW_3 { PROBE_STOW_FEEDRATE, { 270, 125, 0 } }    // Side move to remove probe
  #define MAG_MOUNTED_STOW_4 { PROBE_STOW_FEEDRATE, { 250, 125, 20 } }    // Side move to remove probe
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25, 25.6, -3.22 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 286
#define Y_MAX_POS 253
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE_TRAVEL 170    // (mm/s) Feedrate for G26 XY travel moves.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 40, 40, 46, 40 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT 0.0             // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP 1.0              // (mm) Z raise between tramming points
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 170   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
